...
<html>
  ...
  <body>
    ...
    <h2>Calibration</h2>
      <p>Our calibration images for <strong>low/med/high</strong> are only rough estimates.</p>
      <h3>Data missing, we need your help!</h3>
      <ul>
        <li> <a href="mailto:toro@kanuschle.ch">Mail us</a> your opinion about the flow you see in the Pictures.</li>
        <li> Or, tell us when exactly you paddled the section and how you experienced that level. </li>
      </ul>
    <p>Wishes, advice, contributions welcome too... <a href="mailto:toro@kanuschle.ch">Mail us</a> or use the  <a href="https://github.com/it4paddlers/river-photo-gauge/issues">GitHub Issue Que</a> </p>
    <h2>Ok, enough words, here's the <a href="dist/">Gauge</a></h2>
<!--
